...
test : gx_all $(KVKEYS) $(ENUM_MAPS) $B/test_gxerr ./*.h ./gx*.h ./gxe/*.h
	@rm -f $B/*.o
	$B/test_gxerr
	@rm -f $B/test_gxerr
...
$B/test_gxerr : $B/test_gxerr.o $B/test_gxerr_2.o
	$(call LINK)
$B/test_gxerr.o : $T/test_gxerr.c $B/.kv_keys.h $T/test_gxerr_help.h ./gxe/*.h
	$(call gcc, -I.. -I. -c)
$B/test_gxerr_2.o : $T/test_gxerr_2.c $(KVKEYS) $T/test_gxerr_help.h ./gxe/*.h
	$(call gcc, -I.. -I. -c)
